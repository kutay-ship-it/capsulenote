...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("font-mono text-2xl font-normal leading-snug tracking-normal", className)}
      {...props}
    />
  )
)
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-sm text-gray-secondary font-mono", className)} {...props} />
))

      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Journey Path SVG - Smooth S-curves connecting timeline dots */}
              ...
              {items.length > 1 && (
                <path
                  d={(() => {
                    ...
                    // Two control points ensure horizontal tangents at connection points
                    for (let i = 1; i < items.length; i++) {
                      ...
                      const cp1x = midX
                      const cp1y = prevY  // Horizontal tangent from previous point
                      const cp2x = midX
                      const cp2y = currY  // Horizontal tangent to current point
